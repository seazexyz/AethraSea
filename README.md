...
AethraSea เริ่มต้นจากโปรเจกต์ **ส่วนตัว** — ผมต้องการ serverengine ที่แรงพอจะรันเซิร์ฟเวอร์ของตัวเอง
ได้แบบลื่นๆ โดยไม่ต้องทิ้งปลั๊กอินตัวเก่าที่ใช้มานาน แต่พอทำไปทำมา มันก็กลายเป็นอะไรที่
...
ผลลัพธ์คือ **ได้ทั้งความเร็ว แถมปลั๊กอินเก่ายังได้
ใช้ต่อ [บางตัว]** ไม่ต้องเขียนปลั๊กอินใหม่จากศูนย์
...
ส่วนโค้ดที่เขียนขึ้นใหม่โดย AethraSea ตั้งใจให้ทุกคนใช้และต่อยอดได้หากมีบัคก็มาแจ้งกันด้วยน้าา
